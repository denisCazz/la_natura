...
const fr: Dictionary = {
  meta: {
    ...
    description:
      'Cuisine de campagne \u00e0 Savigliano\u00a0: potager, viande italienne et accueil de Valentin et Silvana. R\u00e9servez pour le d\u00e9jeuner ou le d\u00eener.',
  },
  ...
  luogo: {
    ...
    body: 'Entre Savigliano et la campagne de Cuneo, Valentin et Silvana vous accueillent dans un agriturismo avec jardin et espaces pour les enfants. Lumi\u00e8re, verdure et tables conviviales.',
  ...
  info: {
    ...
    hoursImageAlt: 'Panneau des horaires Agriturismo La Natura\u00a0: ouvert midi et soir, ferm\u00e9 le mardi',
    priceLabel: 'Indicatif',
    price: '20\u201330\u00a0\u20ac par personne',
