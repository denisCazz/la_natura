...
const en: Dictionary = {
  ...
  luogo: {
    ...
    body: 'Between Savigliano and the Cuneo countryside, Valentin and Silvana welcome you to a farmhouse with a garden and spaces for children. Light, greenery and convivial gatherings.',
